  ...
  return (
    <div className='max-w-[1520] mx-auto flex justify-between items-center p-4'>
        <div className="flex items-center">
            ...
            <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>Deliv
        ...
        <button className='bg-orange-700 text-white hidden md:flex items-center py-2 px-3 rounded-full border border-black'>
            <BsFillCartFill/> Cart 
        </button>
            {
                sideNav ? (
            ...
            : 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300'
                ...
                />
                <div className="text-2xl p-4">Deliv<span className='text-orange-700 font-bold'>Eats</span>
                <nav>
